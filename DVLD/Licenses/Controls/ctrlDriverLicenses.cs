...
namespace DVLD.Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if(_Driver == null)
            {
                MessageBox.Show("This is no Driver with ID=" + _Driver.ToString(), "Not Allowed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("This is no Driver link  with Person =" + PersonID.ToString(), "Not Allowed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
